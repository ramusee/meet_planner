  ...
  return (
    <>
      <Stack my="40px" width="100%" alignItems="center" spacing={3}>
        <Typography textAlign="center" color="text.primary" variant="h5" fontWeight="500">
        ...
        >
          ...
          <Stack spacing={2} alignItems="center" height="170px" width="250px">
            <Circle number={2} />
            <Typography variant="inherit" textAlign="center">
              2. Share the link and collect others
            </Typography>
          </Stack>
          <Arrow />
          <Stack spacing={2} alignItems="center" height="170px" width="250px">
            <Circle number={3} />
            <Typography variant="inherit" textAlign="center">
              3. Find matches and schedule meeting
            </Typography>
          </Stack>
        </Stack>
      </Stack>
      <Stack flexGrow="1" alignItems="center">
        ...
        <Stack spacing={2} mt="20px" width="100%" maxWidth="365px" alignItems="center">
          <Button variant="contained" color="success" component={Link} to="date" fullWidth>
            Fill up your slots
          </Button>
          <ShareButton />
        </Stack>
